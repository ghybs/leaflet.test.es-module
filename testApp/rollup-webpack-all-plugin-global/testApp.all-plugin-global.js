import * as L from 'leaflet2';
import '../../testPlugin/global/testPlugin.global'; // Side effect: L.Control and L.control have new class / method.

var mymap = L.map('mymap'),
    parisLatLng = [48.86, 2.34];

L.control.testControl().addTo(mymap); // Using the factory.
// new L.Control.TestControl().addTo(mymap); // Using the class directly.
